...
{\tuc Cesty} jsou posloupnosti uzlů. Uzly se na cestě nemohou opakovat
s~jedinnou výjimkou, že první a poslední bod mohou být shodné, potom se jedná
...
{\tuc Relace} jsou posloupnosti uzlů a cest opatřená atributy. Každý prvek
...
významech. Například klíč \verb|landuse| s~hodnotou \verb|residential|
v~některých místech označoval velké plochy s~obytnými budovami, jinde volně
