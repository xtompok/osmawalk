...
reprezentující mapová data -- ({\tt }, {\tt } a {\tt }), které udržují po řadě
...
Vyhledané trasy je možné uložit do formátu GPX\cite{GPX}. V naší aplikaci používáme pouze trasy, každá
