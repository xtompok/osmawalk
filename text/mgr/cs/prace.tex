...
kombinaci pěší chůze a cestování hromadnou dopravou bývá náročné, obzvlášť v
neznámých částech města. Zpracovali jsme veřejně dostupná data a vytvořili
...
sometimes difficult to choose the right combination of the walking and public
transport especially in distant parts of the city. We processed publicly
...
\include{uvod}
\include{reserse}
\include{vstupni-data}
\include{navrh-reseni}
\include{hledani-trasy}
\include{implementace}
\include{formaty-dat}
\include{uzivatelska-dokumentace}
\include{vysledky}
\include{zaver}
